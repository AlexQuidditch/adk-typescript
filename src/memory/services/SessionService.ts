import type { ListSessionOptions, Session } from '../../models/memory/Session'

import { SessionState } from '../../models/memory/Session'
...
export class InMemorySessionService implements SessionService {
   ...
   * @returns The created session
   */
  public async createSession(userId: string, metadata: Record<string, any> = {}): Promise<Session> {
   ...
   * @returns Array of matching sessions
   */
  public async listSessions(userId: string, options?: ListSessionOptions): Promise<Session[]> {
