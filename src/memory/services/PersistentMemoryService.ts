...
import type { BaseMemoryService, SearchMemoryOptions, SearchMemoryResponse } from '../../models/memory/MemoryService'
...
export class PersistentMemoryService implements BaseMemoryService {
   ...
   */
  public constructor(config: PersistentMemoryServiceConfig) {
   ...
   */
  public async addSessionToMemory(session: Session): Promise<void> {
