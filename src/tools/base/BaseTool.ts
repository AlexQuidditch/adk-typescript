...
export abstract class BaseTool {
   ...
   */
  public getDeclaration(): FunctionDeclaration | null {
    return null
  }
   ...
   */
  public abstract runAsync(args: Record<string, any>, context: ToolContext): Promise<any>
   ...
   */
  public async safeExecute(args: Record<string, any>, context: ToolContext): Promise<any> {
    // Validate arguments
