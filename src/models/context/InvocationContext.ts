...
import type { BaseMemoryService, SearchMemoryOptions, SearchMemoryResponse } from '../memory/MemoryService'
...
export class InvocationContext {
   ...
   */
  public memoryService?: BaseMemoryService
   ...
   */
  public createChildContext(): InvocationContext {
   ...
   */
  public async loadSession(): Promise<Session | undefined> {
   ...
   */
  public async saveSession(): Promise<Session | undefined> {
   ...
   */
  public async searchMemory(query: string, options?: SearchMemoryOptions): Promise<SearchMemoryResponse> {
    if (!this.memoryService) {
      return { memories: [] }
    }
